...
<body>
    ...
    <%--<div class="indexZCWrap">--%>
        <%--<div class="mainInnerBox">--%>
            <%--<h3 class="indexZCH3">Recommandation</h3>--%>
            <%--<ul class="indexZCLabel_ul siteIlB_box">--%>
                <%--<li class="siteIlB_item">--%>
                    <%--<a class="site_ALink" target="_blank" onclick="list2(1,6)">Lunched</a>--%>
                <%--</li>--%>
                <%--<li class="geban siteIlB_item">/</li>--%>
                <%--<li class="siteIlB_item">--%>
                    <%--<a class="site_ALink" target="_blank" onclick="list_catalog1(1,6)">Liked</a>--%>
                <%--</li>--%>
            <%--</ul>--%>
            ...
            <%--<!-- 卡片列表 end -->--%>
            <%--<a href="#" class="indCardListMoreA btn_ALink" target="_blank">浏览更多项目</a>--%>
