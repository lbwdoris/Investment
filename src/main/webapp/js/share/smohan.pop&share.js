...
$(document).ready(function(e) {
	...
	share_html += '<li title="QZone"><a href="javascript:void(0)" class="share1"></a><span></span></li>';
  share_html += '<li title="WeChat"><a href="javascript:void(0)" class="share6"></a><span></span></li>';
  share_html += '<li title="Sina Weibo"><a href="javascript:void(0)" class="share2"></a><span></span></li>';
	share_html += '<li title="RenRen"><a href="javascript:void(0)" class="share3" ></a><span></span></li>';
	share_html += '<li title="Friends"><a href="javascript:void(0)" class="share4"></a><span></span></li>';
	share_html += '<li title="Tencent Weibo"><a href="javascript:void(0)" class="share5"></a><span></span></li>';
	share_html += '</ul></div>';
  ...
  (!!$(".qrcode").length || $('body').append($('<div id="qrcode" class="qrcode none"></div>')))
    ...
    $('.share').SmohanPopLayer({Shade : true,Event:'click',Content : 'Share', Title : 'Share QianQian Investment'});
...
$('#Share li a.share6').click(function(e) {
    ...
    !!$('.qrcode_msg').length || $("#qrcode").append('<p class="t_c qrcode_msg">Point the right corner【...】to share</p><a class="weixin_close" href="javascript:;">Not Share</a>')
